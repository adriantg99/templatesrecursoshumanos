  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a href="constancias.php" class="nav-link active">Constancias</a>
        <a href="estadisticas.php" class="nav-link active">Estadisticas</a>
...
<div class="col">
<div class="row">
<h1>Impresion de Constancias</h1>

</div>

<div class="row mt-10">
    <h4>Ingrese el RFC</h4>
    <div class="autocompletar">
                <input type="text" name="" id="BusquedaPDF" placeholder="Escribe el nombre o RFC">
    </div> 
</div>
...
<div class="row" style="text-align: center;">
    <button  class="boton" type="submit" name="imprimirConstancia" target="_blank">Imprimir constancia</button>
</div>
