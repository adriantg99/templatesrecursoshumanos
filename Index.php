...
<body>
		<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: orangered;">
...
<div class="text-center">
  ...
  <p class="lead">En este modulo de recursos humanos se podran dar de alta a los nuevos trabajadores del instituto</p>
  <hr class="my-4">
  </div>
</div>
